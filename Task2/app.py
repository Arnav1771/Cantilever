...
dataframe = pd.read_csv(r"C:\Users\arnav\Downloads\Credit-card-fraud-detection-Model-main\Credit-card-fraud-detection-Model-main\Project-Dataset.csv\creditcard.csv")
dataframe.head()
